...
train_data = datasets.ImageFolder('/data/dog_images/train', transform=transformer)
valid_data = datasets.ImageFolder('/data/dog_images/test', transform=transformer)
test_data = datasets.ImageFolder('/data/dog_images/valid', transform=transformer)
